// Balatro paint swirl by localthunk (https://www.playbalatro.com),
// shadertoy XXtBRr, image-only. Colors swapped for the nyx ly palette
// (matching balatro_col1/2/3 in the old built-in port).
#define SPIN_ROTATION -2.0
#define SPIN_SPEED 7.0
#define OFFSET vec2(0.0)
#define COLOUR_1 vec4(0.871, 0.267, 0.231, 1.0)
#define COLOUR_2 vec4(0.0, 0.333, 0.706, 1.0)
